...
- This project ports cryptographic and protocol signature logic (including SM3, RC4, and ABogus) derived from [f2](https://github.com/Johnserf-Seed/f2) by [JohnserfSeed](https://github.com/Johnserf-Seed), licensed under the **Apache License, Version 2.0**.